      ...
      <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        <Routes>
          ...
          <Route
            path="/placement/*"
            element={
              <ProtectedRoute allowedRoles={['placement_officer' as UserRole]}>
                <DashboardLayout>
                  <Routes>
                    <Route path="dashboard" element={<Dashboard />} />
                    <Route path="ai-assistant" element={<AIAssistant />} />
          ...
          <Route
            path="/hostel/*"
            element={
              <ProtectedRoute allowedRoles={['hostel_warden' as UserRole, 'admin' as UserRole, 'super_admin' as UserRole]}>
                <DashboardLayout>
                  <Routes>
                    <Route path="dashboard" element={<Dashboard />} />
                    <Route path="ai-assistant" element={<AIAssistant />} />
          ...
          <Route
            path="/library/*"
            element={
              <ProtectedRoute allowedRoles={['librarian' as UserRole, 'admin' as UserRole, 'super_admin' as UserRole]}>
                <DashboardLayout>
                  <Routes>
                    <Route path="dashboard" element={<Dashboard />} />
                    <Route path="library" element={<Library />} />
