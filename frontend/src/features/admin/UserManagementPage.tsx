...
export const UserManagementPage = () => {
  ...
  const handleStatusChange = async (userId: any, newStatus: string) => {
    ...
    try {
      await authService.updateUserStatus(userId, newStatus as any, rejectionReason);
      setUsers((prev) =>
  ...
  const handleDeleteUser = async (userId: any, userFullName: string) => {
  ...
  const handleDeleteCourse = async (courseId: any, title: string) => {
