  ...
  const graphData = useMemo<MindmapNode>(() => {
      ...
      children: [
        ...
        },
        {
          ...
          details: {
            ...
            tech: ['FastAPI', 'SQLAlchemy', 'Featherless AI']
          }
        },
        {
          id: 'be-ai-router',
    ...
    branches.push({
      ...
      details: {
        ...
        role: 'Semantic vector retrieval, Featherless LLM prompt orchestration, anti-hallucination verification, and codebase AST extraction.',
        tech: ['Featherless AI', 'LangChain', 'pgvector', 'NumPy'],
      ...
      children: [
        {
          ...
          details: {
            ...
            tech: ['Featherless AI', 'Prompt Templates', 'Anti-Hallucination']
          }
        },
        {
          ...
          details: {
            ...
            tech: ['AST Parser', 'Semantic Chunker', 'Featherless AI']
          }
        },
        {
          id: 'ai-pdf-processor',
