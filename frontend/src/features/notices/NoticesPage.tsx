          ...
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full space-y-4 border border-slate-200 shadow-2xl relative">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-mono">Target Audience: {activeCircular.target_role || 'All Roles'}</p>
              </div>
            </div>
            ...
            <div className="flex justify-end pt-2">
              <button onClick={() => setActiveCircular(null)} className="px-5 py-2 rounded-xl bg-indigo-600 text-white font-bold text-xs hover:bg-indigo-700 transition-colors">
                Close Notice
              </button>
            </div>
          </div>
