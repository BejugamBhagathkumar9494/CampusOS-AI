              ...
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-lg font-extrabold text-slate-900 flex items-center gap-2">
                    <Users className="w-5 h-5 text-indigo-600" /> Course Student Roster: {selectedCourseRoster.name || selectedCourseRoster.title} ({selectedCourseRoster.code})
                  </h3>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 backdrop-blur-sm p-4 animate-fade-in">
            <div className="bg-white rounded-3xl p-6 max-w-md w-full space-y-5 border border-slate-100 shadow-2xl relative">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="text-sm font-bold text-slate-900">{showSyllabusModal.name || showSyllabusModal.title} ({showSyllabusModal.code})</h4>
