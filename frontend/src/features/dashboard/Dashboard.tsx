...
import {
  ...
  Plus, FileText, CheckCircle2, Award, Bell, Activity, X, GraduationCap
} from 'lucide-react';
    ...
    <div className="space-y-7 animate-fade-in font-sans">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white p-7 rounded-[28px] shadow-xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 z-10">
          ...
          >
            <GraduationCap className="w-4 h-4" /> AI Exam Preparation
          </Link>
          <Link
      ...
      {/* AI Exam Prep Quick Access Card */}
      <div className="bg-gradient-to-r from-purple-900/90 via-indigo-900/90 to-slate-900 text-white p-6 rounded-[28px] shadow-lg border border-purple-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-base font-extrabold text-white flex items-center gap-2">
              AI Exam Preparation from Multiple PDF Notes <span className="px-2 py-0.5 rounded-full bg-purple-500/30 text-purple-200 text-[10px] font-bold">New</span>
            </h3>
            <p className="text-xs text-slate-300 font-medium">
              Upload all unit PDFs (Unit 1–5) for any subject to generate complete summaries, 2-mark, 4-mark, and 10-mark model exam answers.
            </p>
          </div>
        </div>
        <Link
