/**
 * CampusOS AI - Document Management Service
 * Manages document metadata, role access tags, and Supabase Storage uploads.
 */

import { RAGDocument, Role } from '../types/rag';

export async function fetchDocumentsByRole(role: Role): Promise<RAGDocument[]> {
  try {
...
export async function uploadDocument(
  file: File,
  role: Role
): Promise<{ success: boolean; message: string; document?: RAGDocument }> {
  try {
